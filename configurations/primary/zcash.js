...
const config = {};
config.enabled = true;
config.name = 'Pool-Zcash';
config.template = 'zcash';
...
config.primary.payments.daemon.port = 8232;
...
const recipient2 = {};
recipient2.address = 't1NvXnerxQPnoUsYruaPFMRTijEZ1KKqDSR';
